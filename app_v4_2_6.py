...
st.markdown("""
<style>
/* Works on Streamlit 1.20+ (role-based selectors) */
...
.stTabs [role="tab"][aria-selected="true"] {
  background-color: #eafaf0;     /* light green tint */
  color: #14532d;
  border-bottom: 2px solid #22c55e;
}

/* Fallback for older baseweb selectors */
...
with tab_show:
    ...
    with st.sidebar:
        ...
        run = st.button("Generate / Update", type="primary")
